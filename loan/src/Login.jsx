...
class Login extends Component {
    ...
    registerUser() {
        ...
        // Use Promise-based callApi (works for both async/await or fetch-style)
        callApi("POST", BASEURL + 'signup', data)
            .then(this.signupResponse)
    ...
    login() {
        ...
        callApi("POST", BASEURL + "login", data)
    ...
    loginResponse(res) {
        ...
        if (rdata.role && rdata.user) {
            ...
            else if (role === "Analyst" || role === "Financial Analyst") window.location.href = "/analyst";
        } else {
            alert(rdata.message || rdata);
        }
